...
export const copy = {
  en: {
    ...
    viewAll: "VIEW ALL", articlesTitle: "Writing & ideas.", articlesIntro: "Original articles and posts across Business Analysis, product, systems, QA, and applied AI.",
  ...
  pt: {
    ...
    viewAll: "VER TODOS", articlesTitle: "Textos & ideias.", articlesIntro: "Artigos e posts autorais sobre Business Analysis, produto, sistemas, QA e IA aplicada.",
